...
; Function Attrs: nounwind readonly ssp uwtable willreturn
define zeroext i1 @test(i8* nocapture readonly %0) local_unnamed_addr #0 {
  %2 = tail call i32 @strcmp(i8* nonnull dereferenceable(4) getelementptr inbounds ([4 x i8], [4 x i8]* @.str, i64 0, i64 0), i8* nonnull dereferenceable(1) %0)
  %3 = icmp ne i32 %2, 0
  ret i1 %3
}
