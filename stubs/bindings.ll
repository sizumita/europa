...
; Function Attrs: noinline nounwind optnone ssp uwtable
define double @putchard(double %0) #0 {
  ...
  %7 = call i32 @putc(i32 %5, %struct.__sFILE* %6)
...
; Function Attrs: noinline nounwind optnone ssp uwtable
define i32 @printi(i64 %0) #0 {
  %2 = alloca i64, align 8
  store i64 %0, i64* %2, align 8
  %3 = load %struct.__sFILE*, %struct.__sFILE** @__stderrp, align 8
  %4 = load i64, i64* %2, align 8
  %5 = call i32 (%struct.__sFILE*, i8*, ...) @fprintf(%struct.__sFILE* %3, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @.str, i64 0, i64 0), i64 %4)
  ret i32 0
}
...
define i64 @read_int() #0 {
  ...
  %2 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([4 x i8], [4 x i8]* @.str.1, i64 0, i64 0), i64* %1)
...
!7 = !{!"Apple clang version 13.0.0 (clang-1300.0.25.3)"}
